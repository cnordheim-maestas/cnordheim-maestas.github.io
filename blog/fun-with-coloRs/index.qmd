...
One thing that I've learned as a Teaching Assistant and research mentor in data visualization & statistics is that playing with color and customization is a great way to add personality and fun to coding! Without fail, the energy in the room always brightens when we introduce these concepts, but we often do not have time in class to go into depth on color palettes, and other fun ways to add some sparkle to your data visualization.
...
First, let's use the direct color palette package, you can learn more at the package's github: {{< fa brands github >}} [asteves tayloRswift github repository](https://github.com/asteves/tayloRswift)
